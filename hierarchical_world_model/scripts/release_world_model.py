#!/usr/bin/env python3
"""Run the formal staged world-model pipeline from a clean tagged start."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the formal tagged world-model pipeline.")
