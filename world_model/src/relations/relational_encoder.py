...
class RelationalTrafficEncoder(nn.Module):
    ...
    def forward(
        ...
        history_features = self._featureize(history_states, history_valid, ego_mask[:, None, :])
        ...
        current = self.state_mlp(self._featureize(current_states, current_valid, ego_mask))
