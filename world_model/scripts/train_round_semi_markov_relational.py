#!/usr/bin/env python3
"""Train the Semi-Markov relational model on prepared rounD sequences."""
...
def main() -> None:
    ...
    train_semi_markov_world_model(
        load_yaml(path), config_dir=path.parent, epochs=args.epochs,
        rebuild_dataset=args.rebuild_dataset, max_sequences=args.max_sequences,
        max_train_sequences=args.max_train_sequences, max_val_sequences=args.max_val_sequences,
